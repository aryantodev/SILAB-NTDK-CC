...
function EditProfileKoordinator() {
  ...
  // 1. LOAD DATA USER DENGAN REPLIKA AKURASI LINK CLOUD AWS S3
  useEffect(() => {
    if (!token) {
      history.push("/login");
      return;
  ...
  const handleChange = (e) => {
    ...
    if (name === "institusi") return; // Institusi bersifat read-only bagi koordinator
  ...
  const handleAvatarChange = (e) => {
    ...
    if (file) {
      setAvatarFile(file);
      setPreviewAvatar(URL.createObjectURL(file)); // Preview instan lokal browser
    }
  };

  // 2. PROSES TRANSMISI DATA KE BACKEND UNTUK EVALUASI KE S3 CLOUD
          ...
          <div className="col-md-8 col-lg-6">
            ...
            <div className="card shadow-sm border-0 overflow-hidden" style={{ borderRadius: "24px", backgroundColor: "#FFF" }}>
              ...
              <div className="p-4 text-center text-white" style={{ backgroundColor: "#4A3A2E" }}>
                <h4 className="fw-bold mb-1">Pengaturan Akun Koordinator</h4>
                <p className="mb-0 small text-white-50">Lengkapi data verifikasi dan otoritas validasi hasil laboratorium</p>
              </div>
              ...
              <div className="card-body p-4">
                ...
                <div className="text-center mb-4">
                  ...
                  <div className="mt-3">
                    <h5 className="fw-bold mb-0" style={{ color: "#4A3A2E" }}>{formData.full_name || formData.name || "Koordinator Baru"}</h5>
                ...
                <div className="mb-3">
                  ...
                  <small className="text-muted" style={{ fontSize: "11px" }}>Institusi terkunci otomatis khusus untuk akun fungsional koordinator.</small>
                </div>
                ...
                <div className="mb-3">
                  ...
                  <textarea className="form-control rounded-3 border-secondary-subtle" name="bio" value={formData.bio} onChange={handleChange} rows={3} placeholder="Tulis bio singkat otoritas struktural Anda (opsional)..." />
                </div>
